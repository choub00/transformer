        ...
        <div class="brand">
          <div class="brand-icon">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
              ...
              <path d="M24 8L8 32h10v8l6-14l6 14v-8h10L24 8z" fill="url(#iconGrad2)" />
              <defs>
                <linearGradient id="iconGrad2" x1="8" y1="8" x2="40" y2="40">
    ...
    <div class="right-panel">
      <div class="login-card">
        ...
        <div class="login-header">
          <h2>创建账户</h2>
          <p>加入 AlphaTransformer，开启智能投资之旅</p>
        </div>
          ...
          <div class="form-group">
            ...
            <div class="input-wrapper" :class="{ focused: confirmFocused }">
              ...
              <input
                ...
                placeholder="再次输入密码"
                class="form-input"
                @focus="confirmFocused = true; isTyping = true"
                @blur="confirmFocused = false; isTyping = false"
                autocomplete="new-password"
              />
            </div>
        ...
        <p class="signup-prompt">
          已有账户？
          <router-link to="/login" class="signup-link">立即登录</router-link>
        </p>
      </div>
    </div>
  </div>
...
/**
 * RegisterView
 * AlphaTransformer 注册页面，与 LoginView 视觉风格一致
 */
