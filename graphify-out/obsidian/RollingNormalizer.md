...
- [[._compute_rolling_stats()]] - `method` [EXTRACTED]
- [[.fit_transform()]] - `method` [EXTRACTED]
- [[.fit_transform_panel()]] - `calls` [EXTRACTED]
- [[.inverse_transform()]] - `method` [EXTRACTED]
...
- [[滚动窗口归一化器      公式：         x_normt = (xt - mean(xt-windowt))  (std(xt]] - `rationale_for` [EXTRACTED]
